...
basedir = os.path.abspath(os.path.dirname(__file__)) #возвращает нормализованный абсолютный путь

class Config:
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'hard to guess string' #словарь переменных окружения
